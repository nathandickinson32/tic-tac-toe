...
var G__15056 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__15056,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
G__15057.cljs$lang$applyTo = (function (arglist__15060){
...
var G__15058 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__15058,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__15061 = props;
var G__15061__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__15061,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__15061);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__15061__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__15062 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__15062,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__15062;
}
})(),id_class);
...
var temp__5825__auto___15067 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___15067)){
var d_15068 = temp__5825__auto___15067;
if((d_15068 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_15068.s}));
} else {
...
var G__15063 = (cljs.core.count.call(null,argv) - first_child);
switch (G__15063) {
case (0):
...
var vec__15069 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__15069,(0),null);
var id = cljs.core.nth.call(null,vec__15069,(1),null);
var className = cljs.core.nth.call(null,vec__15069,(2),null);
...
var temp__5829__auto___15073 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5829__auto___15073 == null)){
} else {
var key_15074 = temp__5829__auto___15073;
(jsprops.key = key_15074);
}
...
var temp__5829__auto___15079 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5829__auto___15079 == null)){
} else {
var key_15080 = temp__5829__auto___15079;
(jsprops.key = key_15080);
}
...
var temp__5829__auto___15083 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5829__auto___15083 == null)){
} else {
var key_15084 = temp__5829__auto___15083;
(jsprops.key = key_15084);
}
...
var temp__5829__auto___15117 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5829__auto___15117 == null)){
} else {
var key_15118 = temp__5829__auto___15117;
(jsprops.key = key_15118);
}
...
var temp__5829__auto___15119 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5829__auto___15119 == null)){
} else {
var key_15120 = temp__5829__auto___15119;
(jsprops.key = key_15120);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__15086_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__15086_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__15112 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__15112,(0),null);
var derefed = cljs.core.nth.call(null,vec__15112,(1),null);
...
break;
default:
var G__15130 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__15131 = compiler;
v = G__15130;
compiler = G__15131;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template15134 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template15134 = (function (opts,id,fn_to_element,parse_fn,meta15135){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template15134.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15136,meta15135__$1){
var self__ = this;
var _15136__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template15134(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta15135__$1));
}));

(reagent.impl.template.t_reagent$impl$template15134.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15136){
var self__ = this;
var _15136__$1 = this;
return self__.meta15135;
}));

(reagent.impl.template.t_reagent$impl$template15134.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template15134.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template15134.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template15134.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template15134.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template15134.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta15135","meta15135",930351654,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template15134.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template15134.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template15134");

(reagent.impl.template.t_reagent$impl$template15134.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write.call(null,writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template15134");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template15134.
 */
reagent.impl.template.__GT_t_reagent$impl$template15134 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template15134(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta15135){
return (new reagent.impl.template.t_reagent$impl$template15134(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta15135));
});

}

return (new reagent.impl.template.t_reagent$impl$template15134(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
