...
var G__17276 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__17276,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__17276;
}
}));
...
var len__5749__auto___17281 = arguments.length;
var i__5750__auto___17282 = (0);
while(true){
if((i__5750__auto___17282 < len__5749__auto___17281)){
args__5755__auto__.push((arguments[i__5750__auto___17282]));

var G__17283 = (i__5750__auto___17282 + (1));
i__5750__auto___17282 = G__17283;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq17278){
var G__17279 = cljs.core.first.call(null,seq17278);
var seq17278__$1 = cljs.core.next.call(null,seq17278);
var G__17280 = cljs.core.first.call(null,seq17278__$1);
var seq17278__$2 = cljs.core.next.call(null,seq17278__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17279,G__17280,seq17278__$2);
}));
...
var map__17285 = m;
var map__17285__$1 = cljs.core.__destructure_map.call(null,map__17285);
var file = cljs.core.get.call(null,map__17285__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__17285__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__17285__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__17284_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__17284_SHARP_));
 ...
 */
cljs.test.report = (function (){var method_table__5622__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
var formatter_fn = (function (){var or__5025__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var temp__5825__auto___17286 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___17286)){
var message_17287 = temp__5825__auto___17286;
cljs.core.println.call(null,message_17287);
} else {
}
...
var temp__5825__auto___17288 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___17288)){
var message_17289 = temp__5825__auto___17288;
cljs.core.println.call(null,message_17289);
} else {
}
...
var output_dir__$1 = (function (){var G__17290 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__17290,"/"].join('');
} else {
return G__17290;
}
})();
...
var temp__5823__auto__ = new cljs.core.Keyword(null,"source-map","source-map",1706252311).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(temp__5823__auto__)){
var source_map = temp__5823__auto__;
var temp__5823__auto____$1 = cljs.core.get_in.call(null,source_map,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [filename,(line - (1))], null));
if(cljs.core.truth_(temp__5823__auto____$1)){
var columns = temp__5823__auto____$1;
return cljs.core.vec.call(null,cljs.core.map.call(null,cljs.core.first.call(null,(function (){var temp__5823__auto____$2 = cljs.core.get.call(null,columns,(column - (1)));
...
var G__17291 = exception.stack;
var G__17291__$1 = (((G__17291 == null))?null:clojure.string.split_lines.call(null,G__17291));
var G__17291__$2 = (((G__17291__$1 == null))?null:cljs.core.get.call(null,G__17291__$1,depth));
if((G__17291__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__17291__$2);
}
} else {
...
var vec__17292 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__17292,(0),null);
var column = cljs.core.nth.call(null,vec__17292,(1),null);
var vec__17295 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__17295,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__17295,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__17295,(2),null);
...
var m__$1 = (function (){var G__17298 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
while(true){
var temp__5825__auto__ = cljs.core.seq.call(null,fns);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var f = cljs.core.first.call(null,xs__6385__auto__);
var obj = f.call(null);
if(cljs.test.async_QMARK_.call(null,obj)){
return obj.call(null,(function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6385__auto__,temp__5825__auto__){
return (function (){
...
var G__17303 = (function (){var G__17301 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__17301);
} else {
return G__17301;
}
})();
...
return cljs.core.vary_meta.call(null,G__17302,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var temp__5823__auto__ = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5823__auto__)){
...
var vec__17307 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__17307,(0),null);
var types = vec__17307;
...
return cljs.core.map.call(null,(function (p__17310){
var vec__17311 = p__17310;
var ns = cljs.core.nth.call(null,vec__17311,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__17311,(1),null);
return (function (){
...
var G__17314 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__17314__$1 = (((G__17314 instanceof cljs.core.Keyword))?G__17314.fqn:null);
switch (G__17314__$1) {
case "async":
...
var seq__17315 = cljs.core.seq.call(null,vars__$1);
var chunk__17316 = null;
var count__17317 = (0);
var i__17318 = (0);
while(true){
if((i__17318 < count__17317)){
var v = cljs.core._nth.call(null,chunk__17316,i__17318);
var temp__5825__auto___17320 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5825__auto___17320)){
var t_17321 = temp__5825__auto___17320;
each_fixture_fn.call(null,((function (seq__17315,chunk__17316,count__17317,i__17318,t_17321,temp__5825__auto___17320,v,each_fixture_fn,G__17314,G__17314__$1,env,once_fixtures,each_fixtures,vec__17311,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17321)));
});})(seq__17315,chunk__17316,count__17317,i__17318,t_17321,temp__5825__auto___17320,v,each_fixture_fn,G__17314,G__17314__$1,env,once_fixtures,each_fixtures,vec__17311,ns,vars__$1))
);
} else {
}


var G__17322 = seq__17315;
var G__17323 = chunk__17316;
var G__17324 = count__17317;
var G__17325 = (i__17318 + (1));
seq__17315 = G__17322;
chunk__17316 = G__17323;
count__17317 = G__17324;
i__17318 = G__17325;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq.call(null,seq__17315);
if(temp__5825__auto__){
var seq__17315__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__17315__$1)){
var c__5548__auto__ = cljs.core.chunk_first.call(null,seq__17315__$1);
var G__17326 = cljs.core.chunk_rest.call(null,seq__17315__$1);
var G__17327 = c__5548__auto__;
var G__17328 = cljs.core.count.call(null,c__5548__auto__);
var G__17329 = (0);
seq__17315 = G__17326;
chunk__17316 = G__17327;
count__17317 = G__17328;
i__17318 = G__17329;
continue;
} else {
var v = cljs.core.first.call(null,seq__17315__$1);
var temp__5825__auto___17330__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5825__auto___17330__$1)){
var t_17331 = temp__5825__auto___17330__$1;
each_fixture_fn.call(null,((function (seq__17315,chunk__17316,count__17317,i__17318,t_17331,temp__5825__auto___17330__$1,v,seq__17315__$1,temp__5825__auto__,each_fixture_fn,G__17314,G__17314__$1,env,once_fixtures,each_fixtures,vec__17311,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17331)));
});})(seq__17315,chunk__17316,count__17317,i__17318,t_17331,temp__5825__auto___17330__$1,v,seq__17315__$1,temp__5825__auto__,each_fixture_fn,G__17314,G__17314__$1,env,once_fixtures,each_fixtures,vec__17311,ns,vars__$1))
);
} else {
}


var G__17332 = cljs.core.next.call(null,seq__17315__$1);
var G__17333 = null;
var G__17334 = (0);
var G__17335 = (0);
seq__17315 = G__17332;
chunk__17316 = G__17333;
count__17317 = G__17334;
i__17318 = G__17335;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17314__$1)].join('')));
