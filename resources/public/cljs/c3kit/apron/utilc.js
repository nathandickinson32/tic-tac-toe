...
return cljs.core.pr_str.call(null,G__15437);
}
});
/**
...
return cljs.core.assoc.call(null,p1__15448_SHARP_,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__15449_SHARP_),p2__15449_SHARP_);
...
if(cljs.core.truth_((function (){var G__15482 = v;
if((G__15482 == null)){
return null;
} else {
return c3kit.apron.corec.not_blank_QMARK_.call(null,G__15482);
}
})())){
