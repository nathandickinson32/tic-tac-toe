...
var G__21791 = name_or_object;
if(speclj.config.load_reporter_by_name_QMARK_.call(null,name_or_object)){
return speclj.config.load_reporter_by_name.call(null,G__21791);
} else {
return G__21791;
}
});
...
var vec__21792 = speclj.config.parse_tag.call(null,tag);
var flag = cljs.core.nth.call(null,vec__21792,(0),null);
...
var _STAR_runner_STAR__orig_val__21795 = speclj.config._STAR_runner_STAR_;
var _STAR_reporters_STAR__orig_val__21796 = speclj.config._STAR_reporters_STAR_;
var _STAR_specs_STAR__orig_val__21797 = speclj.config._STAR_specs_STAR_;
var _STAR_color_QMARK__STAR__orig_val__21798 = speclj.config._STAR_color_QMARK__STAR_;
var _STAR_profile_QMARK__STAR__orig_val__21799 = speclj.config._STAR_profile_QMARK__STAR_;
var _STAR_omit_pending_QMARK__STAR__orig_val__21800 = speclj.config._STAR_omit_pending_QMARK__STAR_;
var _STAR_full_stack_trace_QMARK__STAR__orig_val__21801 = speclj.config._STAR_full_stack_trace_QMARK__STAR_;
var _STAR_tag_filter_STAR__orig_val__21802 = speclj.config._STAR_tag_filter_STAR_;
var _STAR_runner_STAR__temp_val__21803 = (cljs.core.truth_(new cljs.core.Keyword(null,"runner","runner",1945441304).cljs$core$IFn$_invoke$arity$1(config))?speclj.config.load_runner.call(null,new cljs.core.Keyword(null,"runner","runner",1945441304).cljs$core$IFn$_invoke$arity$1(config)):speclj.config.active_runner.call(null));
var _STAR_reporters_STAR__temp_val__21804 = (cljs.core.truth_(new cljs.core.Keyword(null,"reporters","reporters",-373999166).cljs$core$IFn$_invoke$arity$1(config))?cljs.core.mapv.call(null,speclj.config.load_reporter,new cljs.core.Keyword(null,"reporters","reporters",-373999166).cljs$core$IFn$_invoke$arity$1(config)):speclj.config.active_reporters.call(null));
var _STAR_specs_STAR__temp_val__21805 = new cljs.core.Keyword(null,"specs","specs",1426570741).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_color_QMARK__STAR__temp_val__21806 = new cljs.core.Keyword(null,"color","color",1011675173).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_profile_QMARK__STAR__temp_val__21807 = new cljs.core.Keyword(null,"profile","profile",-545963874).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_omit_pending_QMARK__STAR__temp_val__21808 = new cljs.core.Keyword(null,"omit-pending","omit-pending",-1591740250).cljs$core$IFn$_invoke$arity$1(config);
var _STAR_full_stack_trace_QMARK__STAR__temp_val__21809 = (!((new cljs.core.Keyword(null,"stacktrace","stacktrace",-95588394).cljs$core$IFn$_invoke$arity$1(config) == null)));
var _STAR_tag_filter_STAR__temp_val__21810 = speclj.config.parse_tags.call(null,new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(config));
(speclj.config._STAR_runner_STAR_ = _STAR_runner_STAR__temp_val__21803);

(speclj.config._STAR_reporters_STAR_ = _STAR_reporters_STAR__temp_val__21804);

(speclj.config._STAR_specs_STAR_ = _STAR_specs_STAR__temp_val__21805);

(speclj.config._STAR_color_QMARK__STAR_ = _STAR_color_QMARK__STAR__temp_val__21806);

(speclj.config._STAR_profile_QMARK__STAR_ = _STAR_profile_QMARK__STAR__temp_val__21807);

(speclj.config._STAR_omit_pending_QMARK__STAR_ = _STAR_omit_pending_QMARK__STAR__temp_val__21808);

(speclj.config._STAR_full_stack_trace_QMARK__STAR_ = _STAR_full_stack_trace_QMARK__STAR__temp_val__21809);

(speclj.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR__temp_val__21810);

try{return action.call(null);
}finally {(speclj.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR__orig_val__21802);

(speclj.config._STAR_full_stack_trace_QMARK__STAR_ = _STAR_full_stack_trace_QMARK__STAR__orig_val__21801);

(speclj.config._STAR_omit_pending_QMARK__STAR_ = _STAR_omit_pending_QMARK__STAR__orig_val__21800);

(speclj.config._STAR_profile_QMARK__STAR_ = _STAR_profile_QMARK__STAR__orig_val__21799);

(speclj.config._STAR_color_QMARK__STAR_ = _STAR_color_QMARK__STAR__orig_val__21798);

(speclj.config._STAR_specs_STAR_ = _STAR_specs_STAR__orig_val__21797);

(speclj.config._STAR_reporters_STAR_ = _STAR_reporters_STAR__orig_val__21796);

(speclj.config._STAR_runner_STAR_ = _STAR_runner_STAR__orig_val__21795);
}});
