...
* @constructor
*/
speclj.results.PassResult = (function (characteristic,seconds,assertions){
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"characteristic","characteristic",-1464926600,null),new cljs.core.Symbol(null,"seconds","seconds",1195265333,null),new cljs.core.Symbol(null,"assertions","assertions",668922916,null)], null);
}));
 ...
 */
speclj.results.__GT_PassResult = (function speclj$results$__GT_PassResult(characteristic,seconds,assertions){
return (new speclj.results.PassResult(characteristic,seconds,assertions));
});
...
* @constructor
*/
speclj.results.FailResult = (function (characteristic,seconds,failure,assertions){
this.characteristic = characteristic;
this.seconds = seconds;
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"characteristic","characteristic",-1464926600,null),new cljs.core.Symbol(null,"seconds","seconds",1195265333,null),new cljs.core.Symbol(null,"failure","failure",-1934019890,null),new cljs.core.Symbol(null,"assertions","assertions",668922916,null)], null);
}));
 ...
 */
speclj.results.__GT_FailResult = (function speclj$results$__GT_FailResult(characteristic,seconds,failure,assertions){
return (new speclj.results.FailResult(characteristic,seconds,failure,assertions));
});
...
speclj.results.pass_result = (function speclj$results$pass_result(characteristic,seconds,assertions){
return (new speclj.results.PassResult(characteristic,seconds,assertions));
});
speclj.results.fail_result = (function speclj$results$fail_result(characteristic,seconds,failure,assertions){
return (new speclj.results.FailResult(characteristic,seconds,failure,assertions));
});
...
return cljs.core.update.call(null,tally,new cljs.core.Keyword(null,"pending","pending",-220036727),cljs.core.conj,result);
} else {
if(speclj.results.error_QMARK_.call(null,result)){
return cljs.core.update.call(null,tally,new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.conj,result);
} else {
if(speclj.results.fail_QMARK_.call(null,result)){
return cljs.core.update.call(null,tally,new cljs.core.Keyword(null,"fail","fail",1706214930),cljs.core.conj,result);
} else {
return cljs.core.update.call(null,tally,new cljs.core.Keyword(null,"pass","pass",1574159993),cljs.core.conj,result);
