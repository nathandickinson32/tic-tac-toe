...
return cljs.core.map.call(null,(function (p1__36301_SHARP_){
var next_board = tic_tac_toe.boardc.make_move.call(null,board,p1__36301_SHARP_,token);
...
return new cljs.core.Keyword(null,"move","move",-2110884309).cljs$core$IFn$_invoke$arity$1(cljs.core.apply.call(null,cljs.core.max_key,new cljs.core.Keyword(null,"score","score",-1963588780),cljs.core.map.call(null,(function (p1__36302_SHARP_){
return tic_tac_toe.expert_aic.evaluate_move.call(null,board,token,p1__36302_SHARP_,(0),board_size);
}),tic_tac_toe.boardc.available_moves.call(null,board,board_size))));
});
cljs.core._add_method.call(null,tic_tac_toe.player_typesc.__GT_player_move,new cljs.core.Keyword(null,"expert-ai","expert-ai",218432886),(function (p__36303){
var map__36304 = p__36303;
var map__36304__$1 = cljs.core.__destructure_map.call(null,map__36304);
var board = cljs.core.get.call(null,map__36304__$1,new cljs.core.Keyword(null,"board","board",-1907017633));
var current_token = cljs.core.get.call(null,map__36304__$1,new cljs.core.Keyword(null,"current-token","current-token",428531321));
var board_size = cljs.core.get.call(null,map__36304__$1,new cljs.core.Keyword(null,"board-size","board-size",140730505));
