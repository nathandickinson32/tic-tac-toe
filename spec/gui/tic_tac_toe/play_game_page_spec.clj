(ns tic-tac-toe.play-game-page-spec
  (:require [speclj.core :refer :all]
            [tic-tac-toe.play-game-page :as sut]
...
(describe "play game page"
  ...
  (context "page rendering"
    ...
    (it "renders play game page"
      (sut/play-game-page state)
      (should-have-invoked :background)
      (should-have-invoked :draw-gray-grid-lines)
