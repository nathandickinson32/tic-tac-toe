...
(describe "quil gui"
  ...
  (context "draw-state"
    ...
    (it "draws message when message"
      (sut/draw-state {:board   [[nil nil nil]
                                 [nil nil nil]
                                 [nil nil nil]]
                       :message "Game Over!"})
      ...
      (should-have-invoked :text {:with ["Game Over!" (/ sut/grid-width 2) (- (/ sut/grid-width 2) 80)]}))
    )
